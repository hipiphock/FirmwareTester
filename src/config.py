...
COLOR_COMMAND_LIST = {
    "MOVE TO HUE" : constants.COLOR_CTRL_MV_TO_HUE_CMD,
    "MOVE TO SATURATION" : constants.COLOR_CTRL_MV_TO_SAT_CMD,
    "MOVE TO HUE & SATURATION" : constants.COLOR_CTRL_MV_TO_HUE_SAT_CMD,
